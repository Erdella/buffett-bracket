    ...
    return (
      <div className="w-full space-y-6">
        <p className="text-sm text-muted-foreground">
          Hardcore Parrotheads — fill out your own bracket and let the whole crew's picks crown a winner.
        </p>
    ...
    >
      <TabsList className="grid w-full grid-cols-2 max-w-md">
        ...
        <TabsTrigger value="community" data-testid="tab-community" className="gap-1.5">
          <Users className="h-4 w-4" /> <span className="truncate">Hardcore Parrotheads!</span>
        </TabsTrigger>
      </TabsList>
