export interface SeedAlbum { title: string; year: number; tracks: string[]; }

const seedAlbums: SeedAlbum[] = [
  {
    "title": "Down to Earth",
    "year": 1970,
    "tracks": [
  ...
  {
    "title": "Songs You Don't Know by Heart",
    "year": 2020,
    "tracks": [
      "I Have Found Me a Home",
      "Woman Goin' Crazy on Caroline Street",
